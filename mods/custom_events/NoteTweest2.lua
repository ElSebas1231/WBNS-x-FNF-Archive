...
function onEvent(name, value1, value2)
	if name == 'NoteTweest2' then

if not middlescroll then
setPropertyFromGroup('strumLineNotes',1,'x',getPropertyFromGroup('strumLineNotes',1,'x')-m*1)
noteTweenX('noteTweenX'..1, 1, defaultX[(1%4) + 1], 0.4, 'sineInOut')
setPropertyFromGroup('strumLineNotes',2,'x',getPropertyFromGroup('strumLineNotes',2,'x')-m*1.5)
noteTweenX('noteTweenX'..2, 2, defaultX[(2%4) + 1], 0.4, 'sineInOut')
setPropertyFromGroup('strumLineNotes',3,'x',getPropertyFromGroup('strumLineNotes',3,'x')-m*2)
noteTweenX('noteTweenX'..3, 3, defaultX[(3%4) + 1], 0.4, 'sineInOut')

setPropertyFromGroup('strumLineNotes',4,'x',getPropertyFromGroup('strumLineNotes',4,'x')+m*2)
noteTweenX('noteTweenX'..4, 4, defaultX[(4%8) + 1], 0.4, 'sineInOut')
setPropertyFromGroup('strumLineNotes',5,'x',getPropertyFromGroup('strumLineNotes',5,'x')+m*1.5)
noteTweenX('noteTweenX'..5, 5, defaultX[(5%8) + 1], 0.4, 'sineInOut')
setPropertyFromGroup('strumLineNotes',6,'x',getPropertyFromGroup('strumLineNotes',6,'x')+m*1)
