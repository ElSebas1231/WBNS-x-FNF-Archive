...
function onCreatePost()
    ...
    makeLuaSprite('UpperBar(With HUD)', 'empty', -210, -550)
	makeGraphic('UpperBar(With HUD)', 1900, 550, '000000')
	setObjectCamera('UpperBar(With HUD)', 'HUD')
	addLuaSprite('UpperBar(With HUD)', false)

    makeLuaSprite('LowerBar(With HUD)', 'empty', -210, 720)
	makeGraphic('LowerBar(With HUD)', 1900, 550, '000000')
