function onEvent(name, value1, value2)
	if name == 'Fade UI Complete' then
		...
		elseif type == 7 and duration > 0 then
            ...
            setProperty('healthBarM.alpha', 0)
            setProperty('healtBarM.alpha', 0)
		...
		elseif type == 12 and duration > 0 then
            ...
            doTweenAlpha('hpbarM', 'healthBarM', 0, duration, 'quartInOut')
            doTweenAlpha('hpM', 'healtBarM', 0, duration, 'quartInOut')
            doTweenAlpha('scorebar', 'scoreBar', 0, duration, 'quartInOut')
		end
            ...
            setProperty('healthBarM.alpha', 1)
            setProperty('healtBarM.alpha', 1)
		...
		noteTweenAlpha("noteGoneOpp1", 0, 1, duration, "quartInOut");
            ...
            doTweenAlpha('hpbarM', 'healthBarM', 1, duration, 'quartInOut')
            doTweenAlpha('hpM', 'healtBarM', 1, duration, 'quartInOut')
            doTweenAlpha('scorebar', 'scoreBar', 1, duration, 'quartInOut')
		end
	end
end