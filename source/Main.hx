...
class Main extends Sprite
{
	...
	// Image must be an compiled image
	public static function changeWindowIcon() {
		if (states.freeplay.FreeplaySections.sectionSelected.contains('dlc')) {
			openfl.Lib.application.window.setIcon(lime.graphics.Image.fromFile('assets/shared/images/ui/menus/utils/icon_${states.freeplay.FreeplaySections.sectionSelected}.png'));
		} else {
