...
class VisualsUISubState extends BaseOptionsMenu
{
	...
	public function new()
	{
		...
		rpcTitle = Language.getPhrase('visuals_rpcTitle', 'Visuals Settings Menu');
		...
		var option:Option = new Option('Hide Stickers',
		'If checked, it will not make the stickers transition when exiting gameplay.',
		'noStickers',
		'bool');
	addOption(option);
		...
		var option:Option = new Option('Audio Display Quality',
			'The analytical quality of music data.',
			'audioDisplayQuality',
			'int');
		option.minValue = 1;
		option.maxValue = 4;
		...
		var option:Option = new Option('Audio Display Update',
			'The reaccion interval of the music analyzer on ms.',
			'audioDisplayUpdate',
			'int');
		option.minValue = 0;
		option.maxValue = 200;
