...
class FunkinSoundTray extends FlxSoundTray
{
	...
	public function new()
	{
		...
		bg = new Bitmap(Assets.getBitmapData('assets/shared/images/ui/soundtray/volumebox.png'));
		...
		var backingBar:Bitmap = new Bitmap(Assets.getBitmapData("assets/shared/images/ui/soundtray/bars_10.png"));
		backingBar.x = 9;
		backingBar.y = 5;
		...
		for (i in 1...11)
		{
			bar = new Bitmap(Assets.getBitmapData("assets/shared/images/ui/soundtray/bars_" + i+'.png'));
			bar.x = 9;
			bar.y = 5;
