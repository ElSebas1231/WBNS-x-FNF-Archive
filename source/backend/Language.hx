...
class Language
{
	...
	public static var defaultLangFlag:String = 'en-US'; //en-US
	public static var defaultLangColor:String = 'f6e2e8'; //en-US
	...
	public static function reloadPhrases()
	{
		...
		for (num => phrase in loadedText)
		{
			...
			if(phrase.length < 4 || phrase.startsWith('//') || phrase.startsWith('#')) continue; 
