...
class Controls
{
	...
	public var FP_FAVORITE(get, never):Bool;
	public var FP_LEFT(get, never):Bool;
	public var FP_RIGHT(get, never):Bool;
	private function get_ACCEPT() return justPressed('accept');
	private function get_BACK() return justPressed('back');
	private function get_PAUSE() return justPressed('pause');
	private function get_RESET() return justPressed('reset');
	private function get_FP_FAVORITE() return justPressed('fp_favorite');
	private function get_FP_LEFT() return justPressed('fp_left');
	private function get_FP_RIGHT() return justPressed('fp_right');
