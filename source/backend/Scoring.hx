...
class Scoring
{
	...
	public static function calculateRank(formattedSngName:String):Null<ScoringRank>
	{
...
enum abstract ScoringRank(String)
{
	...
	public function getHorTextAsset()
	{
		...
		{
			case PERFECT_GOLD:
				return 'ui/menus/resultScreen/rankText/rankScrollPERFECT';
			case PERFECT:
				return 'ui/menus/resultScreen/rankText/rankScrollPERFECT';
			case EXCELLENT:
				return 'ui/menus/resultScreen/rankText/rankScrollEXCELLENT';
			case GREAT:
				return 'ui/menus/resultScreen/rankText/rankScrollGREAT';
			case GOOD:
				return 'ui/menus/resultScreen/rankText/rankScrollGOOD';
			case SHIT:
				return 'ui/menus/resultScreen/rankText/rankScrollLOSS';
			default:
				return 'ui/menus/resultScreen/rankText/rankScrollGOOD';
		}
	}
	...
	public function getVerTextAsset()
	{
		...
		{
			case PERFECT_GOLD:
				return 'ui/menus/resultScreen/rankText/rankTextPERFECT';
			case PERFECT:
				return 'ui/menus/resultScreen/rankText/rankTextPERFECT';
			case EXCELLENT:
				return 'ui/menus/resultScreen/rankText/rankTextEXCELLENT';
			case GREAT:
				return 'ui/menus/resultScreen/rankText/rankTextGREAT';
			case GOOD:
				return 'ui/menus/resultScreen/rankText/rankTextGOOD';
			case SHIT:
				return 'ui/menus/resultScreen/rankText/rankTextLOSS';
			default:
				return 'ui/menus/resultScreen/rankText/rankTextGOOD';
		}
	}
