...
class DiscordClient
{
	...
	private static final _defaultID:String = "1352106425559814204";
	public static var clientID(default, set):String = _defaultID;
	private static var presence:DiscordRichPresence = DiscordRichPresence.create();
	private static var button1:DiscordButton = DiscordButton.create();
	private static var button2:DiscordButton = DiscordButton.create();
